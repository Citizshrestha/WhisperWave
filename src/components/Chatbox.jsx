                ...
                <section className="flex flex-col items-start justify-start h-screen w-[100%] background-image">
                    <header className="w-[100%] h-[82px] m:h-fit p-4 bg-white">
                        <main className="flex items-center gap-3">
                            <span>
                                <img src={selectedUser?.image || defaultAvatar} className="object-cover rounded-full w-11 h-11" alt="" />
                            </span>
                            <span>
                                        ...
                                        {msg?.sender === senderEmail ? (
                                            <div className="flex flex-col items-end w-full">
                                                <span className="flex h-auto gap-3 me-10">
                                                    <div>
                                                        ...
                                                        <p className="mt-3 text-right text-gray-400 text-sx">{formatTimestamp(msg?.timestamp)}</p>
                                                    </div>
                                                </span>
                                            </div>
                                        ) : (
                                            <div className="flex flex-col items-start w-full">
                                                <span className="flex gap-3 w-[40%] h-auto ms-10">
                                                    <img src={defaultAvatar} className="object-cover rounded-full h-11 w-11" alt="" />
                                                    <div>
                                                        <div className="flex items-center justify-center p-6 bg-white rounded-lg shadow-sm">
                                                            <h4>{msg.text}</h4>
                                                        </div>
                                                        <p className="mt-3 text-gray-400 text-sx">{formatTimestamp(msg?.timestamp)}</p>
                                                    </div>
                                                </span>
                                            </div>
                                        )}
