    ...
    <section className="sticky top-0 h-[7vh] lg:h-[100vh] w-full lg:w-[9.5rem] bg-[#01AA85] flex lg:flex-col py-8 lg:py-0">
      <div className="flex lg:flex-col items-center lg:items-start justify-between lg:gap-10 w-full px-2 lg:px-0">
        ...
        <ul className="flex lg:flex-col items-center gap-7 md:gap-10 px-2 md:px-0">
          ...
          <li>
            <button aria-label="User Folder" className="text-[1.38rem] lg:text-[1.75rem] cursor-pointer">
          ...
          <li>
            <button aria-label="Files" className="text-[1.38rem] lg:text-[1.75rem] cursor-pointer">
              <RiFile4Line color="#fff" />
            </button>
          </li>
          <li>
            <button aria-label="Bard" className="text-[1.38rem] lg:text-[1.75rem] cursor-pointer">
